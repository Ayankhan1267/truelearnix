...
const navItems = [
  ...
  { href: '/sales/emi',            icon: CalendarCheck,   label: 'EMI Commissions' },
  { href: '/sales/link-generator', icon: Link2,           label: 'Link Generator' },
    ...
    <div className="flex flex-col h-full">
      ...
      <div className="px-5 py-5 border-b border-white/5">
        <div className="flex items-center gap-3">
          ...
          <div>
            <p className="text-white font-bold text-sm leading-tight">Sales Panel</p>
    ...
    <div className="min-h-screen bg-dark-900 flex">
      ...
      <div className="flex-1 sm:ml-56 flex flex-col min-h-screen">
        ...
        <div className="sm:hidden flex items-center justify-between px-4 py-3 bg-dark-800 border-b border-white/5">
          ...
          <span className="text-sm font-semibold text-white">Sales Panel</span>
          <div className="w-9" />
        </div>
